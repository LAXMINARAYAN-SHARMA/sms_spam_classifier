...
model=pickle.load(open(r'C:\Users\LENOVO\OneDrive\Desktop\MY_PROJECT_ML\src\pickle_files\model3.pkl','rb'))
# preproc=pickle.load(open(r'C:\Users\LENOVO\OneDrive\Desktop\MY_PROJECT_ML\src\pickle_files\preprocess_func.pkl','rb'))
vectoriser=pickle.load(open(r'C:\Users\LENOVO\OneDrive\Desktop\MY_PROJECT_ML\src\pickle_files\vectoriser.pkl','rb'))
